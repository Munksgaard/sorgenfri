defmodule SorgenfriWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SorgenfriWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SorgenfriWeb.Gettext, "errors", msg, opts)
    end
  end
